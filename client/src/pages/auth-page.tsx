      ...
      <div className="flex-1 flex flex-col justify-center px-4 py-12 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-primary font-poppins tracking-wide">
              Sqamtho
            </h1>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              {/* <FileUpload
                                ...
                                defaultValue={value || ""}
                              /> */}
                              <div>File upload disabled for debugging</div>
                            </FormControl>
                            <FormMessage className="text-red-500 text-sm" />
                          </FormItem>
                        );
        ...
        <div className="relative z-10 max-w-xl mx-auto">
          <div className="mb-12">
            <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary font-medium text-sm mb-4">
              South Africa's Premier Social Network
            </span>
            ...
            <p className="mt-4 text-xl text-gray-600 leading-relaxed">
              Connect with friends, share moments, and build communities in an
          ...
          <div className="space-y-6">
            <div className="flex items-start p-4 rounded-xl bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-gray-600">
                  Build relationships, share updates, and stay connected with
                  your community across South Africa.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start p-4 rounded-xl bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-gray-600">
                  Instantly chat with friends, create group conversations, and
                  share media seamlessly.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start p-4 rounded-xl bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-gray-600">
                  Find local groups that match your interests and connect with
                  like-minded South Africans.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start p-4 rounded-xl bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-gray-600">
                  Track your finances, manage subscriptions, and achieve your
            ...
            <div className="flex items-start p-4 rounded-xl bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-gray-600">
                  Monitor your health metrics, track your fitness journey, and
                  access wellness resources tailored for South Africans.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="mt-4 text-gray-500 text-sm">
              &copy; {new Date().getFullYear()} Sqamtho · South Africa's Social
              Platform
            </div>
          </div>
        </div>
